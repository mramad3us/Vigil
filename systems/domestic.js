...
var DOMESTIC_THREAT_TO_OP_TYPE = {
  DOMESTIC_EXTREMISM: ['LAW_ENFORCEMENT', 'INVESTIGATION', 'DOMESTIC_SURVEILLANCE', 'ARREST_OPERATION'],
  FINANCIAL_CRIME: ['INVESTIGATION', 'DOMESTIC_SURVEILLANCE', 'ARREST_OPERATION'],
  CYBER_INTRUSION: ['INVESTIGATION', 'DOMESTIC_SURVEILLANCE', 'CYBER_OP', 'LAW_ENFORCEMENT'],
  INSIDER_THREAT: ['INVESTIGATION', 'ARREST_OPERATION', 'DOMESTIC_SURVEILLANCE'],
  ORGANIZED_CRIME: ['LAW_ENFORCEMENT', 'INVESTIGATION', 'ARREST_OPERATION', 'DOMESTIC_SURVEILLANCE'],
  CIVIL_UNREST: ['DOMESTIC_SURVEILLANCE', 'INVESTIGATION', 'LAW_ENFORCEMENT'],
  ...
  DOMESTIC_TERROR: ['LAW_ENFORCEMENT', 'ARREST_OPERATION', 'COUNTER_TERROR', 'DOMESTIC_HOSTAGE_RESCUE'],
  HOSTAGE_DOMESTIC: ['DOMESTIC_HOSTAGE_RESCUE', 'LAW_ENFORCEMENT', 'COUNTER_TERROR'],
  ASSASSINATION_TARGET: ['TARGETED_KILLING', 'ARREST_OPERATION', 'LAW_ENFORCEMENT', 'INVESTIGATION'],
